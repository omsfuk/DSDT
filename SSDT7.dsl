 ...
 *
 * Disassembly of SSDT7.aml, Mon Sep 24 15:44:12 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001D36 (7478)
 *     Revision         0x01
 *     Checksum         0xC2
 *     OEM ID           "HASEE "
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x13)
                {
                    ...
                    If (LAnd (ToInteger (PPST), \_SB.PCI0.LPCB.EC.GP12))
                    {
                        Store (One, \_SB.PCI0.LPCB.EC.EP12)
                        Store (Zero, \_SB.PCI0.LPCB.EC.GP12)
                    }
