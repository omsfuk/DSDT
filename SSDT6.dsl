 ...
 *
 * Disassembly of SSDT6.aml, Mon Sep 24 15:44:12 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000010E5 (4325)
 *     Revision         0x01
 *     Checksum         0x14
 *     OEM ID           "HASEE "
...
DefinitionBlock ("", "SSDT", 1, "HASEE ", "PARADISE", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC__.NVRB, IntObj)
    External (_SB_.PCI0.LPCB.EC__.S3ST, IntObj)
    External (_SB_.PCI0.PEG0, DeviceObj)
    External (_SB_.PCI0.PEG0.PEGP, DeviceObj)
    External (_SB_.PCI0.PEG0.PEGP._ADR, IntObj)
    External (ACDC, FieldUnitObj)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (SGON, 0, Serialized)
        {
            ...
            If (\_SB.PCI0.LPCB.EC.ECOK)
            {
                If (LEqual (\_SB.PCI0.LPCB.EC.NVRB, Zero))
                {
                    Store (One, \_SB.PCI0.LPCB.EC.NVRB)
                    ...
                    Else
                    {
                        ...
                        Else
                        {
                            Store (One, \_SB.PCI0.LPCB.EC.GP12)
                            Store (Zero, \_SB.PCI0.LPCB.EC.EP12)
                            If (\_SB.PCI0.LPCB.EC.S3ST)
                            {
